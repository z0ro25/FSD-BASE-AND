package com.truongnt.fsd.fsd_base_and.tool.sharePreferenceTool;
...
public class SharePrefUtils {
    ...
    public static boolean isPremium(Context context) {
        Log.e("SharePrefUtils", getBoolean(context, "USER_PREMIUM", false).toString() );
        return getBoolean(context, "USER_PREMIUM", false);
    }

    public static void buyPremium(Context context, Boolean value) {
        putBoolean(context, "USER_PREMIUM", value);
    }
    ...
    public static void putAccessToken(Context context, String token) {
        putString(context, ACCESS_TOKEN, token);
    }

    public static boolean isSubscription(Context context) {
        Log.e("SharePrefUtils", getBoolean(context, "USER_SUBS", false).toString() );
        return getBoolean(context, "USER_SUBS", false);
    }

    public static void buySubscription(Context context, Boolean value) {
        putBoolean(context, "USER_SUBS", value);
    }

    public static Boolean canOfferShow(Context context) {
        int count = getCountOpenApp(context);
        return count == 1 || count % 4 == 0;
    }

    public static Boolean isTier1(Context context) {
        return getBoolean(context, "USER_TIER1", false);
    }

    public static void setTier(Context context,Boolean value) {
        putBoolean(context, "USER_TIER1", value);
    }
